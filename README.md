...
- 앱이 말하는 문장 826개(약 9,700자)를 `audio/` 폴더에 MP3로 만들고, 목록을 `js/clips.js`에 적어요. 새로고침하면 바로 새 목소리로 들려요.
...
| 섬 | 배우는 것 |
|---|---|
| ⚡ 포켓몬 잡기 | "야생의 피카츄가 나타났다!" 조사·ㅐㅔ·진짜 이름 찾기 문제를 맞히면 몬스터볼로 잡아 📖 도감(40마리)에 모아요 |
...
포켓몬 이름은 공식 한국어 이름을 쓰고, 그림은 저작권 때문에 넣지 않고 타입 이모지(⚡🔥💧🌱)와 직접 그린 몬스터볼로 표현했어요.
